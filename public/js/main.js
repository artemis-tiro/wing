...
$('.add_input').click(function() {
    ...
    var form = '<tr><td><input class="form-control" name="TYPE_name_NUM" type="text"></td><td><div class="input-group number-container"><input class="form-control number-input' + m + ' canma' + m + '" max="1000000" min="-100000" name="TYPE_price_NUM" type="number"><span class="number-overlap form-control ' + m + '"></span><span class="input-group-text">円</span></div></td><td><div class="input-group number-container"><input class="form-control number-input' + m + ' canma' + m + '" max="1000000" min="-100000" name="TYPE_back_NUM" type="number"><span class="number-overlap form-control ' + m + '"></span><span class="input-group-text">円</span></div></td></tr>';
