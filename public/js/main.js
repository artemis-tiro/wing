...
$('.add_input').click(function() {
    ...
    var form = '<tr class="TYPE"><td><input class="form-control" name="TYPE_name_NUM" type="text"></td> <td class = "input-group" > <input class="form-control" name="TYPE_price_NUM" type="number"><span class="input-group-text">円</span></td><td><div class="input-group"><input class="form-control" name="TYPE_back_NUM" type="number"><span class="input-group-text">円</span></div></td></tr>';
    if (type == "course") {
